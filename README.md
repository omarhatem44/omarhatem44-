...
- 🔭 Focused on **MLOps** — Docker, Kubernetes, CI/CD, model registries, and drift monitoring
- 🏥 Real-world impact: co-developed a heart-sound diagnostic classifier validated on **~1,800 patients** across Egyptian hospitals (~97% agreement with cardiologists)
- 📦 I deploy every project — most of mine are live on AWS with HTTPS, not just repos
- 🎓 Grounded in Andrew Ng's ML & Deep Learning Specializations plus hands-on internship experience
- 💪 Off-screen: at the gym
...
|---|---|---|---|
| **[SalesCast](https://github.com/omarhatem44/SalesCast-Demand-Forecasting-Platform)** | Model-agnostic demand-forecasting platform — auto-detects dataset structure, engineers features, trains & compares models, with drift monitoring and automated retraining | XGBoost · LSTM · Evidently · Airflow · Docker · K8s | [Demo](https://salescast.duckdns.org) |
| **[PredictAI](https://github.com/omarhatem44/PredictAI-Machine-Failure-Prediction-Predictive-Maintenance-)** | Predicts machine failure from live sensor readings so maintenance can be scheduled before breakdown, with animated SHAP explanations | XGBoost · SHAP · FastAPI · AWS EC2 | [Demo](https://machine-health.duckdns.org) |
| **[Chest Cancer Classification](https://github.com/omarhatem44/End-to-end-Chest-Cancer-Classification-)** | End-to-end MLOps pipeline with fine-tuned VGG16, data & pipeline versioning, and experiment tracking | VGG16 · TensorFlow · DVC · MLflow · K8s · AWS | — |
| **[Medical Chatbot](https://github.com/omarhatem44/Medical-Chatbot)** | RAG-based medical assistant with full CI/CD deployment | LangChain · Groq · Pinecone · Flask · AWS | — |
| **[YouTube Sentiment Analysis](https://github.com/omarhatem44/End-to-End-MLOps-System-for-Real-Time-YouTube-Sentiment-Analysis)** | Real-time sentiment analysis served through a Chrome extension | LightGBM · AWS ECR/EC2 | — |
| **[Vehicle Counting](https://github.com/omarhatem44/Vehicle-Counting-YOLOv8)** | Detects and counts vehicles crossing a line from video streams | YOLOv8 · SORT · OpenCV | — |
